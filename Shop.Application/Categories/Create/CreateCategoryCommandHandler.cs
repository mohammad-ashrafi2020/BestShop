...
{
    public class CreateCategoryCommandHandler : IBaseRequestHandler<CreateCategoryCommand>
    {
        private readonly ICategoryRepository _categoryRepository;
        private readonly ICategorySlugUniquenessChecker _slugChecker;
        public CreateCategoryCommandHandler(ICategoryRepository categoryRepository, ICategorySlugUniquenessChecker slugChecker)
        {
